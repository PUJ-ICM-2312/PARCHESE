...
public final class ItemMessageSentBinding implements ViewBinding {
  ...
  private ItemMessageSentBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvMessage,
  ...
  public static ItemMessageSentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageSentBinding((ConstraintLayout) rootView, tvMessage, tvTime);
    }
