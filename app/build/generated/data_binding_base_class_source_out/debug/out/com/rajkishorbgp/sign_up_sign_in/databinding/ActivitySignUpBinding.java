...
public final class ActivitySignUpBinding implements ViewBinding {
  ...
  private ActivitySignUpBinding(@NonNull ScrollView rootView, @NonNull Button loginTab,
      @NonNull Button signupButton, @NonNull EditText signupConfirm, @NonNull EditText signupEmail,
      @NonNull EditText signupName, @NonNull EditText signupPassword, @NonNull Button signupTab) {
  ...
  public static ActivitySignUpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySignUpBinding((ScrollView) rootView, loginTab, signupButton, signupConfirm,
          signupEmail, signupName, signupPassword, signupTab);
    }
