...
public final class ActivitySignUpBinding implements ViewBinding {
  ...
  private ActivitySignUpBinding(@NonNull ScrollView rootView, @NonNull TextView loginRedirectText,
      @NonNull Button loginTab, @NonNull Button signupButton, @NonNull EditText signupConfirm,
  ...
  public static ActivitySignUpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySignUpBinding((ScrollView) rootView, loginRedirectText, loginTab,
          signupButton, signupConfirm, signupEmail, signupName, signupPassword, signupTab);
    }
